...
public class ApiService {
    ...
    public FleventsAccount initDB() throws IOException{
        ...
        FleventsAccount lukas = fleventsAccountRepository.save(new FleventsAccount(null,"Lukas","Burkhardt",true,false,"i21005@hb.dhbw-stuttgart.de",null,"You'll never gona gues this!!",null,null));
        FleventsAccount paul = fleventsAccountRepository.save(new FleventsAccount(null,"Paul","Lehmann",true,false,"paul@hb.dhbw-stuttgart.de",null,"You'll never gonna gues this!!",null,null));
        FleventsAccount ruben = fleventsAccountRepository.save(new FleventsAccount(null,"Ruben","Kraft",true,false,"ruben@hb.dhbw-stuttgart.de",null,"You'll never gonna guess this!!",null,null));
        FleventsAccount pasi = fleventsAccountRepository.save(new FleventsAccount(null,"Pascal","Fuchs",true,false,"pasi@hb.dhbw-stuttgart.de",null,"You'll gonna guess this!!",null,null));
        FleventsAccount david = fleventsAccountRepository.save(new FleventsAccount(null, "David", "Maier",true,false, "dm@flyndre.de", null, "wireshork", null, null));
